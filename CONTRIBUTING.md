...
If you are proposing a new feature, make sure to [open an issue](https://github.com/Norgate-AV-Solutions-Ltd/genlinx/issues/new/choose) to make sure it is inline with the project goals.
...
1. Fork this repository to your own GitHub account and clone it to your local device:
    ...
    ```bash
    git clone https://github.com/{USERNAME}/genlinx.git
    cd genlinx
    ```
