...
export class ArchiveBuilder {
    ...
    #searchForExtraFiles(references) {
        const { extraFilesOnDisk, locatedExtraFileReferences, options } = this;
        ...
        for (const reference of references) {
            ...
            const isIgnored = path.basename(filePath) in options.ignoredFiles;
            if (isIgnored) {
                console.log(
                    chalk.blue(
    ...
    #addExtraFiles() {
        ...
        this.#addEnvFile().#addSymlinkScripts();
