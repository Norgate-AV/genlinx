...
export class CfgBuilder {
    ...
    #addMainRootDirectory(builder, options) {
        ...
        builder
            .appendLine(
                `MainAXSRootDirectory=${path.resolve(options.rootDirectory)}`,
            )
            .appendLine();
    ...
    #addLogFileOptions(builder, options) {
        ...
        const { apw } = this;
        const outputLogFile = `${apw.id}.${options.outputLofFileSuffix}`;
    ...
    #addAdditionalPaths(builder, options) {
        this.#addHeader(builder, [
            ...
            .#addAdditionalIncludePaths(builder, {
                ...options,
                includePath: [...options.includePath, ...this.apw.includePath],
            })
            .#addAdditionalModulePaths(builder, {
                ...options,
                modulePath: [...options.modulePath, ...this.apw.modulePath],
            })
            .#addAdditionalLibraryPaths(builder, options);
