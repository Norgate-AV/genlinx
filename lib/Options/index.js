...
export class Options {
    ...
    static getArchiveOptions(apw, cliOptions, config) {
        return {
            ...
            extraFileLocations: cliOptions.extraFileLocations
                ? [
                      ...config.extraFileLocations,
                      ...cliOptions.extraFileLocations,
                      path.dirname(apw.filePath),
                  ]
                : [...config.extraFileLocations, path.dirname(apw.filePath)],
        };
    }
